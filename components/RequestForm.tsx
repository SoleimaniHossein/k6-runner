...
import { FileText, Download, Upload, X, Plus, FileSpreadsheet, Sparkles, Braces, ChevronDown, ChevronUp, Trash2, GripVertical, Variable, BookOpen, Loader2, Check, Search } from 'lucide-react';
